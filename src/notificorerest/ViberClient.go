...
func (client *ViberClient) GetViberPrices() NotificorePrices {
	var prices NotificorePrices
	_DoJsonRequest(client.BaseClient, viber_get_prices_method, &prices)
	return prices
}

// Retrieve the prices of specified Viber tariff.
func (client *ViberClient) GetViberPricesById(id int) NotificorePrices {
	var prices NotificorePrices
